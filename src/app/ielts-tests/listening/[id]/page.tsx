...
const listeningTests = {
  '1': {
    ...
    instructions: 'Listen to the audio and answer the questions below. You will hear the recording ONCE only.',
    sections: [
      {
        title: 'Section 1',
        description: 'In this section, you will hear a conversation between a woman looking for accommodation and a rental agent. First, you have some time to look at questions 1-3. Now listen carefully and answer questions 1-3.',
        questions: [
          {
            id: 1,
            type: 'mcq',
            text: 'What is the woman looking for?',
            options: ['A. A room to rent', 'B. A house to buy', 'C. An apartment to share', 'D. A studio for work'],
            answer: 'A'
          },
          {
            id: 2,
      ...
      {
        title: 'Section 2',
        description: 'In this section, you will hear a tour guide giving information about local attractions. First, you have some time to look at questions 4-5. Now listen carefully and answer questions 4-5.',
        questions: [
          {
            id: 4,
            type: 'mcq',
            text: 'What is the main topic of the talk?',
            options: ['A. Public transportation', 'B. City history', 'C. Local attractions', 'D. Weather patterns'],
            answer: 'C'
          },
          {
            id: 5,
  ...
  '2': {
    ...
    sections: [
      {
        title: 'Section 1',
        description: 'In this section, you will hear a conversation between a student and an administrator about course registration. First, you have some time to look at questions 1-3. Now listen carefully and answer questions 1-3.',
        questions: [
          {
            id: 1,
            type: 'mcq',
            text: 'What is the purpose of the conversation?',
            options: ['A. Job interview', 'B. Course registration', 'C. Housing inquiry', 'D. Health check'],
            answer: 'B'
          },
          {
            id: 2,
      ...
      {
        title: 'Section 2',
        description: 'In this section, you will hear a lecture about climate science. First, you have some time to look at questions 4-5. Now listen carefully and answer questions 4-5.',
        questions: [
          {
            id: 4,
            type: 'mcq',
            text: 'What is the lecture primarily about?',
            options: ['A. Marine biology', 'B. Climate science', 'C. Sustainable agriculture', 'D. Renewable energy'],
            answer: 'B'
          },
          {
            id: 5,
      ...
      <div className="listening-test-page">
        ...
        <div className="listening-test-content">
          <div className="test-results">
            ...
            <p>You scored {score} out of {getAllQuestions().length}.</p>
    ...
    <div className="listening-test-page">
      ...
      <div className="audio-player-container">
        <div className="audio-player">
          <audio ref={audioRef} src={test.audioUrl} onEnded={() => setIsPlaying(false)} />
      ...
      <div className="two-column-layout" ref={layoutRef}>
        ...
        >
          ...
          <div className="listening-section-content">
            <div className="section-title">{test.sections[activeSection].title}</div>
          ...
          <div className="test-navigation">
            <button 
              ...
              onClick={() => {
                ...
                const currentIndex = allQuestions.findIndex(q => q.id === activeQuestion);
                if (currentIndex > 0) {
