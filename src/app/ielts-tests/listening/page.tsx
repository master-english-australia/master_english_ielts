  ...
  const [tests] = useState<ListeningTest[]>([
    {
      ...
      description: 'Practice your listening skills with this academic test featuring various question types.'
    },
    {
      id: '2',
      type: 'Academic',
      ...
      description: 'Another academic listening test to help you prepare for the IELTS exam.'
    },
    {
      id: '3',
      type: 'General',
      ...
      description: 'Practice your listening skills with this general training test featuring everyday situations.'
    },
    {
      id: '4',
      type: 'General',
      ...
      description: 'Another general training listening test to help you prepare for the IELTS exam.'
    }
  ]);
